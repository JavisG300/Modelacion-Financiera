...
def mbinomial(s,opcion,T,n,r,k,u,d): #Funcion para determinar el precio de la opcion
    ...
    if opcion == 1:
        ...
        print(f'El valor del Call Americano es: {valor_del_call_americano}')
        print('Los nodos del Call Americano son: \n', Nodos)
        ...
        print(f'El valor del Put Americano es: {valor_del_put_americano}')
        print('Los nodos del Put Americano son: \n', Nodos)
